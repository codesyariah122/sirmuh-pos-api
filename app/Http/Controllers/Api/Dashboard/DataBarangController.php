...
public function detail_by_barcode($barcode)
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            $checkAlreadyBarang = Barang::whereKode($request->kode)->get();

            if(count($checkAlreadyBarang) > 0) {
                return response()->json([
                    'success' => false,
                    'message' => "Barang dengan nama {$request->nama}, sudah tersedia"
                ]);
            }
        ...
        public function update(Request $request, $id)
        {
            ...
            try {
                ...
                if($userRole->name === "MASTER" || $userRole->name === "ADMIN" || $userRole->name === "GUDANG") {
                    ...
                    $update_barang->nama = $request->nama ? strtoupper($request->nama) : strtoupper($update_barang->nama);
                    ...
                    $update_barang->harga_partai = $request->hargapartai ? $request->hargapartai : $update_barang->harga_partai;
