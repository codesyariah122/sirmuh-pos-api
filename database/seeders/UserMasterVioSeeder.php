...
class UserMasterVioSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $administrator->name = "komarasari master";
        $administrator->email = "komarasari5@sirmuh.com";
        $administrator->password = Hash::make("Master@123");
